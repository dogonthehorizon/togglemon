...
test_module = testGroup "ToggleMon.IO" [
...
listDirectory = testGroup
    "listDirectory"
    [ testCase
            "should return the contents of the given directory"
        $ do
              result <- runTestMonad'
